<?php $__env->startSection('title',translate('Ads Create')); ?>

<?php $__env->startPush('css_or_js'); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/public/assets/admin-module/css/daterangepicker.css')); ?>"/>
<?php $__env->stopPush(); ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-4">
                        <h2 class="page-title mb-2"><?php echo e(translate('Create New Advertisement')); ?></h2>
                        <p><?php echo e(translate('Boost Your Visibility with Targeted Ads')); ?></p>
                    </div>
                    ...
                    <div class="card mb-30">
                        <div class="card-body p-30">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(route('provider.advertisements.ads-store')); ?>" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating form-floating__icon mb-30">
                                            <select class="js-select theme-input-style promotion_type w-100" name="type">
                                                <option value="video_promotion" <?php echo e(old('type') == 'video_promotion' ? 'selected' : ''); ?>>
                                                    <?php echo e(translate('Video Promotion')); ?>

                                                </option>
                                                <option value="profile_promotion" <?php echo e(old('type') == 'profile_promotion' ? 'selected' : ''); ?>>
                                                    <?php echo e(translate('Profile Promotion')); ?>
                                        ...
                                        <?php if($language): ?>
                                            <div class="lang-form" id="default-form">
                                                <div class="form-floating form-floating__icon mb-30">
                                                    <input type="text" class="form-control" id="title-default" name="title[]"
                                                           placeholder="<?php echo e(translate('Title')); ?>" required="" maxlength="255"
                                                           data-preview-text="preview-title-default"/>
                                                    <label for="title"><?php echo e(translate('title')); ?> (<?php echo e(translate('default')); ?>)</label>
                                                    <span class="material-icons">title</span>
                                                </div>
                                                <div class="form-floating mb-30">
                                            <textarea class="form-control resize-none" id="description-default" required
                                                      placeholder="<?php echo e(translate('description')); ?>" maxlength="100"
                                                      name="description[]"
                                                      data-preview-text="preview-description-default"></textarea>
                                                    <label for="description"><?php echo e(translate('description')); ?> (<?php echo e(translate('default')); ?>)</label>
                                                </div>
                                            </div>
                                            ...
                                            <?php $__currentLoopData = $language?->live_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="lang-form d-none" id="<?php echo e($lang['code']); ?>-form">
                                                    <div class="form-floating form-floating__icon mb-30">
                                                        <input type="text" class="form-control" id="title-<?php echo e($lang['code']); ?>" maxlength="255"
                                                               name="title[]"
                                                               placeholder="<?php echo e(translate('Title')); ?>"
                                                               data-preview-text="preview-title-<?php echo e($lang['code']); ?>"/>
                                                        <label for="title"><?php echo e(translate('title')); ?>

                                                            (<?php echo e(strtoupper($lang['code'])); ?>)</label>
                                                        <span class="material-icons">title</span>
                                                    </div>
                                                    <div class="form-floating mb-30">
                                                    <textarea class="form-control resize-none" id="description-<?php echo e($lang['code']); ?>"
                                                              placeholder="<?php echo e(translate('description')); ?>" maxlength="100"
                                                              name="description[]"
                                                              data-preview-text="preview-description-<?php echo e($lang['code']); ?>"></textarea>
                                                        <label for="description"><?php echo e(translate('description')); ?>
                                        ...
                                        <div class="promotion-typewise-upload-box" id="video-upload-box">
                                            <div class="border rounded p-3">
                                                <div class="d-flex flex-column align-items-center gap-3">
                                                    <p class="title-color mb-0 text-uppercase"><?php echo e(translate('Upload Your Video')); ?>
                                                    ...
                                                    <p class="opacity-75 max-w220 mx-auto text-center fs-12">
                                                        <?php echo e(translate('Maximum 50 MB')); ?>

                                                        <br>
                                                        <?php echo e(translate('Supports: MP4, MKV, WEBM')); ?>
                                        ...
                                        <div class="promotion-typewise-upload-box" id="profile-upload-box">
                                            <br>
                                            <h5 class="mb-3"><?php echo e(translate('Show Review & Ratings')); ?></h5>
                                            <div class="card bg--secondary shadow-none">
                                                <div class="card-body p-3">
                                                    <div class="w-100 d-flex flex-wrap gap-3">
                                                        <label class="form-check form--check me-3">
                                                            <input type="checkbox" class="form-check-input" name="review" <?php echo e(old('review') ? 'checked' : ''); ?>>
                                                            <span class="form-check-label"><?php echo e(translate('Review')); ?></span>
                                                        </label>
                                                        <label class="form-check form--check">
                                                            <input type="checkbox" class="form-check-input" name="rating" <?php echo e(old('rating') ? 'checked' : ''); ?>>
                                            ...
                                            <div class="border rounded p-3">
                                                <div class="d-flex flex-column align-items-center gap-3">
                                                    <p class="title-color mb-0 text-uppercase"><?php echo e(translate('Upload your profile Image')); ?>

                                                        (1:1)</p>

                                                    <div class="upload-file max-w-130px">
                                                        <input type="file" class="cover_attachment js-upload-input"
                                                               data-target="profile-prev-image" name="profile_image" accept=".<?php echo e(implode(',.', array_column(IMAGEEXTENSION, 'key'))); ?>, |image/*">
                                                    ...
                                                    <p class="opacity-75 max-w220 mx-auto text-center fs-12">
                                                        <?php echo e(translate('Supports: PNG, JPG, JPEG, GIF')); ?>

                                                        <br>
                                                        <?php echo e(translate('Maximum 10 MB')); ?>
                                            ...
                                            <div class="border rounded p-3">
                                                <div class="d-flex flex-column align-items-center gap-3">
                                                    <p class="title-color mb-0 text-uppercase"><?php echo e(translate('Upload your Cover Image')); ?>

                                                        (2:1)</p>

                                                    <div class="upload-file">
                                                        <input type="file" class="cover_attachment js-upload-input" data-target="main-image" name="cover_image" accept=".<?php echo e(implode(',.', array_column(IMAGEEXTENSION, 'key'))); ?>, |image/*">
                                                        <div class="upload-file__img upload-file__img_banner">
                                                               <img src="<?php echo e(asset('public/assets/admin-module/img/media/banner-upload-file.png')); ?>" alt="">
                                                        </div>
                                                        <button class="remove-file-button" type="button">
                                                            <span class="material-symbols-outlined">close</span>
                                                        </button>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="position-sticky top-80px text-8797AB">
                                            <p class="title-color mb-2 fs-6"><?php echo e(translate('Advertisement Preview')); ?></p>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="w-0 d-flex flex-column gap-2 flex-grow-1">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="review--text static-text"> <?php echo e(translate('Reviews')); ?></span>
                                                                        <div
...
<?php $__env->startPush('script'); ?>
    <script type="text/javascript" src="<?php echo e(asset('/public/assets/admin-module/js/moment.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('/public/assets/admin-module/js/daterangepicker.min.js')); ?>"></script>
    ...
    <script>
        $(".video_attachment").on("change", function (event) {
            ...
            $(this).closest('.upload-file').find('.remove-file-button').on('click', function () {
                ...
                $(this).closest('.upload-file').find('.upload-file__img').html('<img src="<?php echo e(asset('public/assets/admin-module/img/media/banner-upload-file.png')); ?>" alt="">');
    ...
    <script>
        $(document).ready(function () {
            ...
            var providerId = "<?php echo e(Auth::user()->provider->id); ?>";

            // Check if providerId is not null or empty before making the AJAX request
            if (providerId) {
                $.ajax({
                    url: '<?php echo e(route("admin.provider.get-provider-info", ":provider_id")); ?>'.replace(':provider_id', providerId),
                    type: 'GET',
                    success: function (response) {
                        ...
                        $('.review--text').html(response.reviews + ' ' + '<?php echo e(translate("Reviews")); ?>');
                    },
                    error: function (xhr) {
...
<?php echo $__env->make('providermanagement::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/housecraft/public_html/Modules/PromotionManagement/Resources/views/provider/advertisements/ads-create.blade.php ENDPATH**/ ?>