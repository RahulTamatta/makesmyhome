                ...
                <div class="col-12">
                    ...
                    <div class="card mb-30">
                        <div class="card-body p-30">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(route('admin.advertisements.ads-store')); ?>" method="POST"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating form-floating__icon mb-30">
                                            <select class="js-select theme-input-style w-100 provider-info"
                                                    name="provider_id"
                                                    required>
                                                <option value=""><?php echo e(translate('Select Provider')); ?></option>
                                                <?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($provider['id']); ?>"><?php echo e($provider['company_name']); ?>
                                        ...
                                        <div class="form-floating form-floating__icon mb-30">
                                            <select class="js-select theme-input-style w-100 promotion_type"
                                                ...
                                                <option value="video_promotion"
                                                        selected><?php echo e(translate('Video Promotion')); ?></option>
                                                <option
                                                    value="profile_promotion"><?php echo e(translate('Profile Promotion')); ?></option>
                                            </select>
                                        </div>
                                        ...
                                        <?php if($language): ?>
                                            ...
                                            <?php $__currentLoopData = $language?->live_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="lang-form d-none" id="<?php echo e($lang['code']); ?>-form">
                                                    <div class="form-floating form-floating__icon mb-30">
                                                        <input type="text" class="form-control" id="title-<?php echo e($lang['code']); ?>"
                                                    ...
                                                    <div class="w-100 d-flex flex-wrap gap-3">
                                                        <label class="form-check form--check me-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                   name="review">
                                                            <span
                                                                class="form-check-label"><?php echo e(translate('Review')); ?></span>
                                                        </label>
                                                        <label class="form-check form--check">
                                                            <input type="checkbox" class="form-check-input"
                                                                   name="rating">
                                                            <span
                                                                class="form-check-label"><?php echo e(translate('Rating')); ?></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="position-sticky top-80px">
                                            <div class="bg-light p-3 p-sm-4 rounded text-8797AB">
                                                <p class="title-color"><?php echo e(translate('Advertisement Preview')); ?></p>
...
<?php echo $__env->make('adminmodule::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/housecraft/public_html/Modules/PromotionManagement/Resources/views/admin/advertisements/ads-create.blade.php ENDPATH**/ ?>