<?php $__env->startSection('title',translate('zone_edit')); ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title"><?php echo e(translate('zone_update')); ?></h2>
                    </div>

                    <div class="card zone-setup-instructions mb-30">
                        <div class="card-body p-30">
                            <form action="<?php echo e(route('admin.zone.update',[$zone->id])); ?>" enctype="multipart/form-data"
                                  method="POST">
                                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="media gap-3 align-items-center">
                                                <img
                                                    ...
                                                    alt="<?php echo e(translate('image')); ?>">
                                                <div class="media-body ">
                                                    <p><?php echo e(translate('click_this_icon_to_start_pin_points_in_the_map_and_connect_them_
                                                        to_draw_a_
                                            ...
                                            <div class="map-img mt-4">
                                                <img src="<?php echo e(asset('public/assets/admin-module/img/instructions.gif')); ?>"
                                                     alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        ...
                                        <?php if($language): ?>
                                            <div class="form-floating form-floating__icon mb-30 lang-form" id="default-form">
                                                <input type="text" name="name[]" class="form-control"
                                                       ...
                                                       value="<?php echo e($zone?->getRawOriginal('name')); ?>" required>
                                                <label><?php echo e(translate('zone_name')); ?> (<?php echo e(translate('default')); ?>)</label>
                                            ...
                                            <?php $__currentLoopData = $language?->live_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-floating form-floating__icon mb-30 d-none lang-form"
                                                    ...
                                                    <input type="text" name="name[]" class="form-control"
                                                           placeholder="<?php echo e(translate('zone_name')); ?>"
                                                           value="<?php echo e($translate[$lang['code']]['zone_name']??''); ?>">
                                                ...
                                                <div class="mb-30">
                                                    <div class="form-floating form-floating__icon">
                                                        <input type="text" class="form-control" name="name[]"
                                                               placeholder="<?php echo e(translate('zone_name')); ?> *"
                                                               required value="<?php echo e($zone->name); ?>">
                                        ...
                                        <div class="form-group mb-3 coordinates">
                                            ...
                                            <textarea type="text" rows="8" name="coordinates" id="coordinates"
                                                ...
                                                <?php $__currentLoopData = $zone->coordinates[0]->toArray()['coordinates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$coords): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if (count($zone->coordinates[0]->toArray()['coordinates']) != $key + 1){if ($key != 0) echo(','); ?>(<?php echo e($coords[1]); ?>,<?php echo e($coords[0]); ?>)<?php } ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </textarea>
                                        </div>
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        ...
        function set_all_zones() {
            $.get({
                url: '<?php echo e(route('admin.zone.get-active-zones',[$zone->id])); ?>',
                dataType: 'json',
...
<?php echo $__env->make('adminmodule::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/housecraft/public_html/Modules/ZoneManagement/Resources/views/admin/edit.blade.php ENDPATH**/ ?>