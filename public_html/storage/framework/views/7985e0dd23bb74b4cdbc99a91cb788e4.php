...
<html lang="en">
<head>
    <title><?php echo e(translate('admin_login')); ?></title>
...
<div>
    <form action="<?php echo e(route('admin.auth.login')); ?>" enctype="multipart/form-data" method="POST"
            id="login-form">
        <?php echo csrf_field(); ?>
            ...
            <div class="login-right-wrap bg-white">
                ...
                <div class="login-right w-100 m-auto p-3">
                    <div class="d-flex justify-content-between align-items-start gap-2 mb-5 mt-3">
                        <div class="d-flex flex-column gap-2">
                            <h2 class="c1 fw-medium"><?php echo e(translate('admin_Sign_In')); ?></h2>
                        ...
                        <div class="mb-5">
                            <div class="form-floating form-floating__icon">
                                <input type="email" name="email_or_phone" class="form-control"
                                        placeholder="<?php echo e(translate('example@gmail.com')); ?>" required="" id="email">
                        ...
                        <div class="mb-3">
                            <div class="form-floating form-floating__icon">
                                <input type="password" name="password" class="form-control"
                                        placeholder="<?php echo e(translate('********')); ?>" required=""
                                        id="password">
                    ...
                    <div class="d-flex mb-4">
                        <button class="btn btn--primary flex-grow-1 text-capitalize" id="signInBtn"
                                type="submit"><?php echo e(translate('sign_in')); ?></button>
                    </div>

                    <div class="mt-3 d-flex flex-wrap gap-1 justify-content-center">
                        <?php echo e(translate('want_to_sign_in_to_your_provider_account')); ?> ?
                        <a href="<?php echo e(route('provider.auth.login')); ?>"
                            class="c1 text-decoration-underline"><?php echo e(translate('sign_in_here')); ?></a>
                    </div>
                </div>
                ...
                <?php if(env('APP_ENV')=='demo'): ?>
                    <div class="login-footer d-flex justify-content-between c1-bg text-white">
                        <div>
                            <div><?php echo e(translate('email')); ?> : <?php echo e(translate('admin@admin.com')); ?></div>
...
<?php /**PATH /home/housecraft/public_html/Modules/Auth/Resources/views/admin-login.blade.php ENDPATH**/ ?>