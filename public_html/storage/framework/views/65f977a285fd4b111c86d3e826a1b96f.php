        ...
        <div class="row">
            ...
            <div class="col-md-6 d-flex justify-content-center justify-content-md-end">
                <ul class="list-inline list-separator">
                    ...
                    <li>
                        <span
                            class="badge badge-success opacity-75"><?php echo e(translate('Software_version')); ?> : <?php echo e(env('SOFTWARE_VERSION')); ?></span>
                    </li>
                </ul>
            </div>
        </div>
...
<?php /**PATH /home/housecraft/public_html/Modules/AdminModule/Resources/views/layouts/partials/_footer.blade.php ENDPATH**/ ?>