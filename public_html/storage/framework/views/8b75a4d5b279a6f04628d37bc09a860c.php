<?php $__env->startSection('title',translate('update_provider')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="main-content">
        <div class="container-fluid">
            ...
            <form action="<?php echo e(route('admin.provider.update', [$provider->id])); ?>" method="POST" id="create-provider-form"
                ...
                <section>
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title"><?php echo e(translate('update_Provider')); ?></h2>
                    </div>
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-md-6" id="register-form-p-0">
                                    ...
                                    <div class="form-floating form-floating__icon mb-30">
                                        <input type="text" class="form-control"
                                               value="<?php echo e($provider->company_name); ?>"
                                               name="company_name" required maxlength="191"
                                               placeholder="<?php echo e(translate('Company_/_Individual_Name')); ?>">
                                    ...
                                    <div class="form-floating mb-30">
                                        ...
                                        <input type="tel" class="form-control company_phone phone-input-with-country-picker-provider iti__tel-input" id="company_phone"
                                               name="company_phone" value="<?php echo e($provider->company_phone); ?>"
                                               placeholder="<?php echo e(translate('Phone')); ?>" required>
                                        <div class="">
                                            <input type="text" class="country-picker-phone-number-provider w-50" value="<?php echo e(old('company_phone')); ?>" name="company_phone" hidden  readonly>
                                        </div>
                                    </div>
                                    <div class="form-floating form-floating__icon mb-30">
                                        <input type="email" class="form-control"
                                               name="company_email" value="<?php echo e($provider->company_email); ?>"
                                    ...
                                    <div class="form-floating mb-30">
                                        <select class="select-identity theme-input-style w-100" name="zone_id"
                                                required>
                                            <option disabled selected><?php echo e(translate('Select_Zone')); ?></option>
                                            <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($zone->id); ?>"
                                                    <?php echo e($provider->zone_id == $zone->id ? 'selected': ''); ?>>
                                    ...
                                    <div class="form-floating mb-30">
                                                <textarea class="form-control resize-none" placeholder="<?php echo e(translate('Address')); ?>"
                                                          ...
                                                          required><?php echo e($provider->company_address); ?></textarea>
                                                ...
                                                <div>
                                                    <div class="upload-file">
                                                        ...
                                                        <div class="upload-file__img">
                                                            <img src="<?php echo e($provider->logo_full_path); ?>" alt="<?php echo e(translate('image')); ?>">
                                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mb-30">
                                        <select class="select-identity theme-input-style w-100"
                                            ...
                                            <option selected
                                                    disabled><?php echo e(translate('Select_Identity_Type')); ?></option>
                                            <option value="passport"
                                                <?php echo e($provider->owner->identification_type == 'passport' ? 'selected': ''); ?>>
                                                <?php echo e(translate('Passport')); ?></option>
                                            <option value="driving_license"
                                                <?php echo e($provider->owner->identification_type == 'driving_license' ? 'selected': ''); ?>>
                                                <?php echo e(translate('Driving_License')); ?></option>
                                            <option value="nid"
                                                <?php echo e($provider->owner->identification_type == 'nid' ? 'selected': ''); ?>>
                                                <?php echo e(translate('nid')); ?></option>
                                            <option value="trade_license"
                                                <?php echo e($provider->owner->identification_type == 'trade_license' ? 'selected': ''); ?>>
                                                <?php echo e(translate('Trade_License')); ?></option>
                                        </select>
                                    </div>
                                    <div class="form-floating form-floating__icon mb-30">
                                        <input type="text" class="form-control" name="identity_number"
                                               value="<?php echo e($provider->owner->identification_number); ?>"
                                            ...
                                            <div class="upload-file w-100">
                                                ...
                                                <div id="multi_image_picker">
                                                    <?php $__currentLoopData = $provider->owner->identification_image_full_path; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <img class="p-1" height="150" src="<?php echo e($image); ?>" alt="<?php echo e(translate('image')); ?>">
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-floating form-floating__icon mb-30">
                                                <input type="text" class="form-control" name="contact_person_name"
                                                       value="<?php echo e($provider->contact_person_name); ?>" placeholder="name"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating mb-30">
                                                        ...
                                                        <input type="tel" class="form-control phone-input-with-country-picker-provider2 iti__tel-input"
                                                               ...
                                                               value="<?php echo e($provider->contact_person_phone); ?>"
                                                               placeholder="<?php echo e(translate('Phone')); ?>"
                                                               required>
                                                        <div class="">
                                                            <input type="text" class="country-picker-phone-number-provider2 w-50" value="<?php echo e(old('contact_person_phone')); ?>" name="contact_person_phone" hidden  readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-floating form-floating__icon mb-30">
                                                        <input type="email" class="form-control"
                                                               ...
                                                               value="<?php echo e($provider->contact_person_email); ?>"
                                    ...
                                    <div class="form-floating form-floating__icon mb-30">
                                        <input type="email" class="form-control"
                                               name="company_email" value="<?php echo e($provider->owner->email); ?>" readonly
                                               placeholder="<?php echo e(translate('Email')); ?>" required>
                                        <label><?php echo e(translate('Email')); ?></label>
                                        <span class="material-icons">mail</span>
                                    </div>
                                    <div class="form-floating mb-30">
                                        <label for="account_phone"><?php echo e(translate('Phone')); ?></label>
                                        <input type="tel" class="form-control phone-input-with-country-picker-provider3 iti__tel-input"
                                                name="account_phone"
                                                id="account_phone"
                                                value="<?php echo e($provider->owner->phone); ?>"
                                                placeholder="<?php echo e(translate('Phone')); ?>"
                                                required>
                                        <div class="">
                                            <input type="text" class="country-picker-phone-number-provider3 w-50" value="<?php echo e(old('account_phone')); ?>" name="account_phone" hidden  readonly>
                                        </div>
                                    </div>
                                    <div class="row gx-2">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="mb-30">
                                            <div class="form-floating form-floating__icon">
                                                <input type="text" class="form-control" name="latitude"
                                                       ...
                                                       value="<?php echo e($provider->coordinates['latitude'] ?? null); ?>"
                                                       required readonly
                                        ...
                                        <div class="mb-30">
                                            <div class="form-floating form-floating__icon">
                                                <input type="text" class="form-control" name="longitude"
                                                       ...
                                                       value="<?php echo e($provider->coordinates['longitude'] ?? null); ?>"
                                                       required readonly
                                                       data-bs-toggle="tooltip" data-bs-placement="top"
                                                       title="<?php echo e(translate('Select from map')); ?>">
                ...
                <section>
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title mb-2"><?php echo e(translate('Update Provider')); ?></h2>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-4">
                                <?php if($commission): ?>
                                    <div class="col-sm-6">
                                        <label class="input-radio-item">
                                            <input type="radio" class="subscription-type" name="plan_type" value="commission_based" <?php echo e(!$packageSubscription ? 'checked' : ''); ?>>
                                            <div class="inner">
                                ...
                                <?php if($subscription): ?>
                                    <div class="col-sm-6">
                                        <label class="input-radio-item">
                                            <input type="radio" class="subscription-type" name="plan_type" value="subscription_based"  <?php echo e($packageSubscription ? 'checked' : ''); ?>>
                                            <div class="inner">
                                                <div class="w-0 flex-grow-1">
                                                            ...
                                                            <?php $__currentLoopData = $formattedPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="swiper-slide h-auto">
                                                                    <label class="d-block plan-item">
                                                                        <input type="radio" name="plan" id="<?php echo e($package->id); ?>" <?php echo e($packageSubscription?->subscription_package_id ==  $package->id ? 'checked' : ''); ?> class="package-option" data-id="<?php echo e($package->id); ?>">
            ...
            $(document).ready(function () {
                function initAutocomplete() {
                    var myLatLng = {
                        ...
                        lat:<?php echo e($provider->coordinates['latitude'] ?? 23.811842872190343); ?>,
                        lng:<?php echo e($provider->coordinates['longitude'] ?? 90.356331); ?>
...
<?php echo $__env->make('adminmodule::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/housecraft/public_html/Modules/ProviderManagement/Resources/views/admin/provider/edit.blade.php ENDPATH**/ ?>