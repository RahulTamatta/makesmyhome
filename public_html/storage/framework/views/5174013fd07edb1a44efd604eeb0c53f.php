...
<html lang="en">
<head>
    <title><?php echo e(translate('Provider_Registration')); ?></title>
...
<body>
    ...
    <div class="dark-support">
        <div class="register-wrap style__two">
            <div class="register-left d-flex justify-content-center align-items-center bg-center" data-bg-img="<?php echo e(asset('public/assets/provider-module')); ?>/img/media/login-bg.png">
            ...
            <div class="register-right-wrap bg-white">
                <div class="register-right mx-auto p-3">
                    <div class="text-center mb-5 d-flex flex-column gap-2 mt-3">
                        <h2 class="c1 fw-medium"><?php echo e(translate('Self_Registration')); ?></h2>
                        <p><?php echo e(translate('Sign up to provide service broadly')); ?></p>
                    </div>

                    <form action="<?php echo e(route('provider.auth.sign-up-submit')); ?>" method="POST" enctype="multipart/form-data" id="register-vertical-steps">
                        <?php echo csrf_field(); ?>

                        <h3><?php echo e(translate('Step 1')); ?></h3>
                        <section>
                            <div class="" id="register-form-p-0">
                                <h3 class="border-bottom mb-4 pb-2"><?php echo e(translate('Basic Information')); ?></h3>
                                <h5 class="border-bottom mb-4 pb-2"><?php echo e(translate('General_Information')); ?></h5>
                                <div class="mb-4">
                                    <div class="mb-30">
                                        <div class="form-floating form-floating__icon">
                                            <input type="text" class="form-control"
                                                    value="<?php echo e(old('company_name')); ?>" name="company_name"
                                                    placeholder="<?php echo e(translate('Company_Name')); ?>">
                                            <label><?php echo e(translate('Company_Name')); ?> <span class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-30">
                                        <div class="form-floating form-floating__icon">
                                            <input type="email" id="company_email" class="form-control"
                                                    value="<?php echo e(old('company_email')); ?>" name="company_email"
                                    ...
                                    <div class="mb-30">
                                        <div class="country-picker-1">
                                            <input type="tel" class="form-control phone-input-with-country-picker9"
                                                    value="<?php echo e(old('company_phone')); ?>" name="company_phone"
                                                    id="company_phone"
                                                    placeholder="<?php echo e(translate('123 456 789')); ?>" maxlength="255">
                                            <div class="">
                                                <input type="text" class="country-picker-phone-number w-50" value="<?php echo e(old('company_phone')); ?>" name="company_phone" hidden  readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-30">
                                        <div class="form-floating form-floating__icon">
                                                <input type="text" class="form-control" name="company_address"
                                                            placeholder="<?php echo e(translate('Address')); ?>" value="<?php echo e(old('company_address')); ?>">
                                            <label><?php echo e(translate('Address')); ?> <span class="text-danger">*</span></label>
                                            <span class="material-icons">location_on</span>
                                        </div>
                                    </div>
                                    <div class="mb-30">
                                        <h5 class="mb-3"><?php echo e(translate('company_logo')); ?> (1:1) <span class="text-danger">*</span></h5>
                                            ...
                                            <div>
                                                <div class="form-error-wrap upload-file">
                                                    ...
                                                    <div class="upload-file__img">
                                                        <img
                                                            src="<?php echo e(asset('public/assets/provider-module')); ?>/img/media/upload-file.png"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <p class="opacity-75 max-w220"><?php echo e(translate('Image_format_-_jpg,_png,_jpeg,_gif_Image_Size_-_maximum_size_2_MB_Image_Ratio_-_1:1')); ?></p>
                                        </div>
                                    </div>

                                    <div class="border-bottom d-flex align-items-center justify-content-between gap-2 pb-2 mb-4">
                                        <h5><?php echo e(translate('Contact Person Information')); ?></h5>
                                        <div class="d-flex gap-2 align-items-center">
                                            <label for="sameAsGI"><?php echo e(translate('Same as general info')); ?></label>
                                        ...
                                        <div class="mb-30">
                                            <div class="country-picker-2">
                                                <input type="tel" class="form-control phone-input-with-country-picker10"
                                                        value="<?php echo e(old('contact_person_phone')); ?>"
                                                        id="contact_person_phone"
                                                        name="contact_person_phone"
                                                        placeholder="<?php echo e(translate('123 456 789')); ?>">
                                                <div class="">
                                                    <input type="text" class="country-picker-phone-number2 w-50" value="<?php echo e(old('contact_person_phone')); ?>" name="contact_person_phone" hidden  readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-30">
                        ...
                        <section>
                            <div class="">
                                <h5 class="border-bottom mb-4 pb-2"><?php echo e(translate('Business_Information')); ?></h5>
                                <div class="mb-4">
                                    <div class="mb-30">
                                        <div class="form-error-wrap">
                                            <select name="zone_id" id="zone_id" class="form-select">
                                                <option value="0" selected
                                                        disabled><?php echo e(translate('Select_Zone')); ?></option>
                                                <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($zone->id); ?>" <?php echo e(old('zone_id')==$zone->id?'selected':''); ?>><?php echo e($zone->name); ?></option>
                                            ...
                                            <div class="mb-30">
                                                <div class="form-floating">
                                                    <input type="text" id="latitude" name="latitude"
                                                            ...
                                                            title="<?php echo e(translate('Select from map')); ?>" readonly>
                                                    <label for="latitude"><?php echo e(translate('latitude')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-30">
                                                <div class="form-floating">
                                                    <input type="text" step="0.1" name="longitude"
                                                            class="form-control"
                                                            placeholder="<?php echo e(translate('Ex:')); ?> 90.356331"
                                                            id="longitude"
                                                            value="<?php echo e(old('longitude')); ?>" required
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="<?php echo e(translate('Select from map')); ?>" readonly>
                                                    <label for="longitude"><?php echo e(translate('longitude')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-30">
                                        <div class="form-error-wrap">
                                            <select name="identity_type" id="identity_type"
                                                    class="form-select">
                                                <option value="0" selected disabled><?php echo e(translate('Identity_Type')); ?></option>
                                    ...
                                    <div class="mb-30">
                                        <div class="form-floating form-floating__icon">
                                            <input type="text" class="form-control"
                                                    value="<?php echo e(old('identity_number')); ?>" name="identity_number"
                                                    placeholder="<?php echo e(translate('Identity_Number')); ?>">
                                    ...
                                    <div class="mb-4">
                                        <div class="form-error-wrap">
                                            <div class="mb-3"><?php echo e(translate('Identity_Image')); ?>(2:1) <span class="text-danger">*</span></div>
                        ...
                        <h3><?php echo e(translate('Step 3')); ?></h3>
                        <section>
                            <div class="">
                                <h5 class="border-bottom mb-4 pb-2"><?php echo e(translate('account_Information')); ?></h5>
                                <div class="mb-4">
                                    ...
                                    mail you need to go to first stage">
                                        <div class="form-floating form-floating__icon">
                                            <input type="email" id="account_email" class="form-control"
                                                    ...
                                                    placeholder="<?php echo e(translate('Email')); ?>" readonly>
                                            <label><?php echo e(translate('Email')); ?> <span class="text-danger">*</span></label>
                                            <span class="material-icons">mail</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-30">
                                        <div class="form-floating form-floating__icon">
                                            ...
                                            <label><?php echo e(translate('Confirm_Password')); ?> <span class="text-danger">*</span></label>
                                            <span class="material-icons">lock</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <h3><?php echo e(translate('Step 4')); ?></h3>
                        <section>
                            <div class="">
                                <h5 class="border-bottom mb-4 pb-2"><?php echo e(translate('Choose_Business_Plan')); ?></h5>
                                        ...
                                        <?php if($commission): ?>
                                            <label class="business-plan-option border active rounded p-3 d-flex justify-content-between gap-2">
                                                <div class="d-flex flex-column gap-2">
                                                    <h4><?php echo e(translate('Commision Base')); ?></h4>
                                                    <div><?php echo e(translate('You_have_to_give_a_certain_percentage_of_commission_to_admin_for_every_booking_request')); ?></div>
                                                </div>

                                                <input value="commision_base" type="radio" name="choose_business_plan" class="position-static w-26" checked>
                                            </label>
                                        <?php endif; ?>
                                        <?php if($subscription && count($formattedPackages) > 0): ?>
                                            <label class="business-plan-option border rounded p-3 d-flex justify-content-between gap-2">
                                                <div class="d-flex flex-column gap-2">
                                                    <h4><?php echo e(translate('Subscription Base')); ?></h4>
                                                    <div><?php echo e(translate('You_have_to_pay_a_certain_amount_in_every_month_/_year_to_admin_as_subscription_fee')); ?></div>
                                                </div>
                                ...
                                <?php if($subscription): ?>
                                    <div class="priceBoxSwiper-wrap">
                                        <h5 class="mt-4 mb-3 text-center"><?php echo e(translate('Select Plan')); ?></h5>
                                                ...
                                                <div class="swiper-wrapper">
                                                    ...
                                                    <?php $__currentLoopData = $formattedPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="swiper-slide h-auto">
                                                            <div class="price-box <?php echo e($index == 1 ? 'active' : ''); ?> d-flex flex-column rounded-3 border h-100 package-option" data-id="<?php echo e($package->id); ?>">
                                    ...
                                    <div class="d-flex flex-column gap-3 mt-4">
                                        <?php if($freeTrialStatus): ?>
                                            <label class="business-plan-option border active rounded p-3 d-flex justify-content-between gap-2">
                                                <div class="d-flex flex-column gap-2">
                                                    <h4><?php echo e(translate('Continue with')); ?> <?php echo e($duration); ?> <?php echo e(translate('Days')); ?> <?php echo e(translate('Free Trial')); ?></h4>
                                                    <div><?php echo e(translate('Use the system free for')); ?> <?php echo e($duration); ?> <?php echo e(translate('days')); ?>. <?php echo e(translate('After that you
                                        ...
                                        <?php if($digitalPayment): ?>
                                            <label class="business-plan-option payment_methods_list_container border rounded p-3">
                                                <div class="d-flex justify-content-between gap-2">
                                                    <div class="d-flex flex-column gap-2">
                                                        <h4><?php echo e(translate('Select Payment Method')); ?></h4>
                                                        <div><?php echo e(translate('You can use any of our secure payment method & get selected subscription plan features')); ?></div>
                                                    </div>
                                                ...
                                                <div class="payment_methods_list d-flex flex-column gap-3">
                                                    ...
                                                    <input type="hidden" name="callback" value="<?php echo e(route('provider.auth.login')); ?>">
                                                    ...
                                                    <label class="payment-method-option border active rounded p-3 d-flex justify-content-between">
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img width="70" src="<?php echo e(onErrorImage(
                                                                    ...
                                                                    'payment_modules/gateway_image/')); ?>" alt="<?php echo e(translate('gateway image')); ?>">
                                                            <div><?php echo e($gateway['label']); ?></div>
                                                        </div>

                                                        <input value="<?php echo e($gateway['gateway']); ?>" type="radio" name="payment_method" class="position-static" <?php echo e($loop->first ? 'checked' : ''); ?>>
                                                    </label>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            </label>
                ...
                onStepChanging: function (event, currentIndex, newIndex) {
                    ...
                    switch (currentIndex) {
                        case 0:
                            ...
                            $.ajax({
                                url: "<?php echo e(route('check-unique-user')); ?>",
                                type: "POST",
                                headers: {
...
<?php /**PATH /home/housecraft/public_html/Modules/Auth/Resources/views/provider-register.blade.php ENDPATH**/ ?>