<?php $__env->startSection('title', translate('employee_update')); ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title"><?php echo e(translate('Update_employee')); ?></h2>
                    </div>

                    <div class="card">
                        <div class="card-body py-4">
                            <form id="add-new-employee-form" action="<?php echo e(route('admin.employee.update',[$employee->id])); ?>"
                                ...
                                <div>
                                    <div>
                                        <div class="d-flex gap-1 flex-column">
                                            <h4><?php echo e(translate('Employee Info')); ?></h4>
                                            <p class="fs-12"><?php echo e(translate('Give employee’s basic and account info')); ?></p>
                                        </div>
                                    </div>
                                    <section>
                                        <div class="d-flex flex-column gap-1 mb-20">
                                            <h4><?php echo e(translate('General_Information')); ?></h4>
                                            <p><?php echo e(translate('Fill an employee’s general info such as name, address number and set
                                                role')); ?></p>
                                        </div>
                                                        ...
                                                        <div class="input-wrap form-floating">
                                                            ...
                                                            <div class="">
                                                                <input type="text"
                                                                       ...
                                                                       value="<?php echo e(old('phone')); ?>" name="phone" hidden
                                                                       readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-30">
                                                        <div class="input-wrap form-floating form-floating__icon">
                                                            <input type="text" class="form-control" id="address"
                                                                   ...
                                                                   value="<?php echo e($employee->addresses->first()->address); ?>"
                                                                   required>
                                                    ...
                                                    <div class="col-md-6 mb-30">
                                                        <div class="input-wrap">
                                                            <select class="select-identity theme-input-style role-btn"
                                                                ...
                                                                <option selected
                                                                        disabled><?php echo e(translate('Select_role')); ?></option>
                                                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option
                                                                        value="<?php echo e($role->id); ?>" <?php echo e($employee->roles->where('id',$role->id)->first()?'selected':''); ?>>
                                                        ...
                                                        <div class="input-wrap">
                                                            <select class="zone-select theme-input-style"
                                                                ...
                                                                <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option
                                                                        value="<?php echo e($zone->id); ?>" <?php echo e(in_array($zone->id,$employee->zones->pluck('id')->toArray())?'selected':''); ?>><?php echo e($zone->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex flex-column gap-1 align-items-center">
                                                    <div class="input-wrap">
                                                        <div class="d-flex flex-column align-items-center gap-3">
                                                            <div class="text-muted"><?php echo e(translate('Employee Image')); ?>
                                                                ...
                                                                <div class="upload-file">
                                                                    ...
                                                                    <div class="upload-file__img">
                                                                        <img class="onerror-image"
                                                                             src="<?php echo e($employee->profile_image_full_path); ?>"
                                        ...
                                        <div class="d-flex flex-column gap-1 mb-20">
                                            ...
                                            <p><?php echo e(translate('Give verified information to verify a employee')); ?></p>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 mb-30">
                                                <div class="input-wrap">
                                                    ...
                                                    <select class="select-identity theme-input-style"
                                                        ...
                                                        <?php $__currentLoopData = $id_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                value="<?php echo e($type); ?>" <?php echo e($type==$employee->identification_type?'selected':''); ?>><?php echo e(translate($type)); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                <div class="input-wrap form-floating form-floating__icon mt-30">
                                                    <input type="text" class="form-control" name="identity_number"
                                                           ...
                                                           value="<?php echo e($employee->identification_number); ?>" required>
                                            ...
                                            <div class="col-lg-6 mb-30">
                                                <div class="input-wrap">
                                                    <div class="d-flex flex-column align-items-center gap-3">
                                                        <div class="text-muted"><?php echo e(translate('Identification_Image')); ?>

                                                            (2:1) <span class="text-danger">*</span></div>
                                                        <div id="multi_image_picker" class="w-100">
                                                            <?php $__currentLoopData = $employee->identification_image_full_path; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $identification_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <img class="p-1" height="150" src="<?php echo e($identification_image); ?>" alt="<?php echo e(translate('identity-image')); ?>">
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </div>
                                                        <p class="opacity-75 max-w220 mx-auto text-center fs-12">
                                                            <?php echo e(translate('Upload jpg, png, jpeg, gif maximum 2 MB')); ?>
                                        ...
                                        <div class="d-flex flex-column gap-1 mb-20">
                                            ...
                                            <p><?php echo e(translate('This info will need for employee’s future login')); ?></p>
                                        </div>
                                            ...
                                            <div class="col-lg-4 mb-30">
                                                <div class="input-wrap form-floating form-floating__icon">
                                                    <input type="password" class="form-control" name="password" value=""
                                                           placeholder="<?php echo e(translate('Password')); ?>" id="pass">
                                                    <label><?php echo e(translate('Password')); ?></label>
                                                    <span class="material-icons togglePassword">visibility_off</span>
                                                    <span class="material-icons">lock</span>
                                                </div>
                                                <small
                                                    class="text-danger d-flex mb-30 mt-1"><?php echo e(translate('Password_Must_be_at_Least_8_Digits')); ?></small>
                                            </div>
                                            <div class="col-lg-4 mb-30">
                                                <div class="input-wrap form-floating form-floating__icon">
                                    ...
                                    <div>
                                        <div class="d-flex gap-1 flex-column">
                                            <h4><?php echo e(translate('Set Permissions')); ?></h4>
                                            <p class="fs-12"><?php echo e(translate('Set what individuals on this role can do')); ?></p>
                                        </div>
                                    </div>
                                    <section>
                                        <div class="d-flex flex-column gap-1 mb-20">
                                            <h4><?php echo e(translate('Set_Permission')); ?></h4>
                                            <p><?php echo e(translate('Modify what individuals on this role can do')); ?></p>
                                        </div>
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            const id = '<?php echo e($employee->id); ?>';
        ...
        function permission(roleId, id) {
            $.ajax({
                url: '<?php echo e(route('admin.employee.ajax.employee.role.access')); ?>',
                method: 'GET',
    ...
    <script>
        ...
        const identificationImageCount = <?php echo e(count($employee->identification_image)); ?>;
        let maxCount;
...
<?php echo $__env->make('adminmodule::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/housecraft/public_html/Modules/AdminModule/Resources/views/admin/employee/edit.blade.php ENDPATH**/ ?>