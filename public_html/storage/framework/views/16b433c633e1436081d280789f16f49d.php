<?php $__env->startSection('title',translate('update_coupon')); ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title"><?php echo e(translate('update_coupon')); ?></h2>
                    </div>
                            ...
                            <form action="<?php echo e(route('admin.coupon.update',[$coupon->id])); ?>" method="POST">
                                ...
                                <div class="coupon-type">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-30">
                                                <select class="js-select theme-input-style w-100" name="coupon_type"
                                                        id="coupon-type">
                                                    <option><?php echo e(translate('select_coupon_type')); ?></option>
                                                    <?php $__currentLoopData = COUPON_TYPES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$coupon_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
                                                            value="<?php echo e($index); ?>" <?php echo e($coupon->coupon_type==$index?'selected':''); ?>>
                                                            <?php echo e($coupon_type); ?>
                                            ...
                                            <div class="mb-30">
                                                <div class="form-floating form-floating__icon">
                                                    <input type="text" class="form-control" name="coupon_code"
                                                           ...
                                                           placeholder="<?php echo e(translate('coupon_code')); ?>">
                                        ...
                                        <div
                                            class="col-12 <?php echo e($coupon['coupon_type'] != 'customer_wise' ? 'd-none' : ''); ?>"
                                                ...
                                                <select class="js-select theme-input-style w-100" id="customer-select"
                                                    ...
                                                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($customer->id); ?>"
                                                            <?php echo e($coupon->coupon_customers->contains('customer_user_id', $customer->id) ? 'selected' : ''); ?>>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center gap-4 mb-30">
                                        <div class="custom-radio">
                                            <input type="radio" id="category" name="discount_type"
                                                   value="category" <?php echo e($coupon->discount->discount_type=='category'?'checked':''); ?>>
                                            <label for="category"><?php echo e(translate('category_wise')); ?></label>
                                        </div>
                                        <div class="custom-radio">
                                            <input type="radio" id="service" name="discount_type"
                                                   value="service" <?php echo e($coupon->discount->discount_type=='service'?'checked':''); ?>>
                                            <label for="service"><?php echo e(translate('service_wise')); ?></label>
                                        </div>
                                        <div class="custom-radio">
                                            <input type="radio" id="mixed" name="discount_type"
                                                   value="mixed" <?php echo e($coupon->discount->discount_type=='mixed'?'checked':''); ?>>
                                    ...
                                    <?php if($language): ?>
                                        <div class="form-floating form-floating__icon mb-30 lang-form" id="default-form">
                                            <input type="text" name="discount_title[]" class="form-control"
                                                   ...
                                                   value="<?php echo e($discount?->getRawOriginal('discount_title')); ?>" required>
                                        ...
                                        <?php $__currentLoopData = $language?->live_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="form-floating form-floating__icon mb-30 d-none lang-form"
                                                ...
                                                <input type="text" name="discount_title[]" class="form-control"
                                                       placeholder="<?php echo e(translate('discount_title')); ?>"
                                                       value="<?php echo e($translate[$lang['code']]['discount_title'] ?? ''); ?>">
                                                <label><?php echo e(translate('discount_title')); ?> (<?php echo e(strtoupper($lang['code'])); ?>
                                    ...
                                    <?php else: ?>
                                        <div class="form-floating form-floating__icon mb-30">
                                            <input type="text" name="discount_title[]" class="form-control"
                                                   placeholder="<?php echo e(translate('discount_title')); ?>"
                                                   value="value="<?php echo e($discount->discount_title); ?>"" required>
                                    ...
                                    <div class="mb-30" id="category_selector"
                                         style="display: <?php echo e(($coupon->discount->discount_type=='category' || $coupon->discount->discount_type=='mixed')?'block':'none'); ?>">
                                        <select class="category-select theme-input-style w-100" name="category_ids[]"
                                                multiple="multiple"
                                                id="category_selector__select" <?php echo e(($coupon->discount->discount_type=='category' || $coupon->discount->discount_type=='mixed')?'required':''); ?>>
                                            <option value="all"><?php echo e(translate('Select All')); ?></option>
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($category->id); ?>" <?php echo e(in_array($category->id,$coupon->discount->category_types->pluck('type_wise_id')->toArray())?'selected':''); ?>>
                                    ...
                                    <div class="mb-30" id="service_selector"
                                         style="display: <?php echo e(($coupon->discount->discount_type=='service' || $coupon->discount->discount_type=='mixed')?'block':'none'); ?>">
                                        <select class="service-select theme-input-style w-100" name="service_ids[]"
                                            ...
                                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($service->id); ?>" <?php echo e(in_array($service->id,$coupon->discount->service_types->pluck('type_wise_id')->toArray())?'selected':''); ?>>
                                    ...
                                    <div class="mb-30">
                                        <select class="zone-select theme-input-style w-100" name="zone_ids[]"
                                            ...
                                            <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($zone->id); ?>" <?php echo e(in_array($zone->id,$coupon->discount->zone_types->pluck('type_wise_id')->toArray())?'selected':''); ?>>
                                ...
                                <div class="coupon-amount-type">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center gap-4 mb-30">
                                        <div class="custom-radio">
                                            <input type="radio" id="percentage" name="discount_amount_type"
                                                   value="percent" <?php echo e($coupon->discount->discount_amount_type=='percent'?'checked':''); ?>>
                                            <label for="percentage"><?php echo e(translate('percentage')); ?></label>
                                        </div>
                                        <div class="custom-radio">
                                            <input type="radio" id="fixed_amount" name="discount_amount_type"
                                                   value="amount" <?php echo e($coupon->discount->discount_amount_type=='amount'?'checked':''); ?>>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-30">
                                                <div class="form-floating form-floating__icon">
                                                    <input type="number" class="form-control" name="discount_amount"
                                                           value="<?php echo e($coupon->discount->discount_amount); ?>"
                                                           id="discount_amount"
                                                           placeholder="<?php echo e(translate('amount')); ?>" step="any"
                                                           min="0.01" <?php echo e($coupon->discount->discount_amount_type == 'percent'? 'max=100' : ''); ?>>
                                                    <label id="discount_amount__label"><?php echo e(translate('amount')); ?>

                                                        (<?php echo e($coupon->discount->discount_amount_type == 'amount' ? currency_symbol() : '%'); ?>
                                            ...
                                            <div class="mb-30">
                                                <div class="form-floating">
                                                    <input type="date" class="form-control" name="start_date"
                                                           value="<?php echo e($coupon->discount->start_date); ?>">
                                            ...
                                            <div class="mb-30">
                                                <div class="form-floating">
                                                    <input type="date" class="form-control" name="end_date"
                                                           value="<?php echo e($coupon->discount->end_date); ?>">
                                            ...
                                            <div class="mb-30">
                                                <div class="form-floating form-floating__icon">
                                                    <input type="number" class="form-control" step="any"
                                                           ...
                                                           value="<?php echo e($coupon->discount->min_purchase); ?>"
                                                           min="0">
                                        ...
                                        <div class="col-lg-4" id="max_discount_amount"
                                             style="display: <?php echo e($coupon->discount->discount_amount_type=='amount'?'none':'block'); ?>">
                                            <div class="mb-30">
                                                <div class="form-floating form-floating__icon">
                                                    <input type="number" class="form-control" step="any"
                                                           name="max_discount_amount"
                                                           placeholder="<?php echo e(translate('max_discount_amount')); ?> (<?php echo e(currency_symbol()); ?>)"
                                                           value="<?php echo e($coupon->discount->max_discount_amount); ?>"
                                                           min="0">
                                        ...
                                        <div
                                            class="col-lg-4 <?php echo e($coupon['coupon_type'] == 'first_booking' ? 'd-none' : ''); ?>"
                                            id="limit_per_user__div">
                                            <div class="mb-30">
                                                <div class="form-floating form-floating__icon">
                                                    <input type="number" class="form-control" name="limit_per_user"
                                                           value="<?php echo e($coupon->discount?->limit_per_user); ?>"
                                                           id="limit_per_user"
                                                           placeholder="1" <?php echo e($coupon['coupon_type'] == 'first_booking' ? 'required' : ''); ?>>
...
<?php echo $__env->make('adminmodule::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/housecraft/public_html/Modules/PromotionManagement/Resources/views/admin/coupons/edit.blade.php ENDPATH**/ ?>