<?php $__env->startSection('title', translate('role_update')); ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title"><?php echo e(translate('role_update')); ?></h2>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-4 mb-lg-0">
                                        <div class="form-floating form-floating__icon mb-30">
                                            <input type="text" class="form-control" name="role_name" value="<?php echo e($role->role_name); ?>"
                                        ...
                                        <div class="mb-4">
                                            <div class="d-flex gap-4 align-items-center mb-1">
                                                ...
                                                <div class="bg--secondary px-2 py-1 rounded d-flex gap-1 align-items-center">
                                                    ...
                                                    <label class="user-select-none" for="select_all"><?php echo e(translate('Select_All')); ?></label>
                                                </div>
                                            </div>
                                            ...
                                            <?php if(!isset($module['submodules']) && empty($module['submodules'])): ?>
                                                    <div class="col-sm-6 col-lg-3">
                                                        <div class="bg--secondary px-3 py-2 rounded d-flex gap-1 align-items-center">
                                                            <label class="user-select-none flex-grow-1" for="<?php echo e($module['key']); ?>"><?php echo e($module['value']); ?></label>
                                                            <input type="checkbox" name="modules[<?php echo e($module['key']); ?>]" id="<?php echo e($module['key']); ?>" <?php if($matchedRoleAccess): ?> checked <?php endif; ?>>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card checkbox_card overflow-hidden">
                                                            <div class="checkbox_card__head bg--secondary p-3 d-flex gap-1 align-items-center">
                                                                <label class="user-select-none flex-grow-1" for="<?php echo e($module['key']); ?>"><?php echo e($module['value']); ?></label>
                                                                <input class="" type="checkbox" name="section_modules[<?php echo e($module['key']); ?>]" id="<?php echo e($module['key']); ?>">
                                                            </div>
                                                                ...
                                                                <div class="grid-columns">
                                                                    <?php $__currentLoopData = $module['submodules']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submodule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <div class="d-flex gap-1 align-items-center">
                                                                            <input class="mb-1" type="checkbox" name="modules[<?php echo e($submodule['key']); ?>]" id="<?php echo e($submodule['key']); ?>" <?php if($matchedRoleAccess): ?> checked <?php endif; ?>>
                                            ...
                                            <tr>
                                                <td>
                                                    <label class="switcher mx-auto">
                                                        <input class="switcher_input" name="add" type="checkbox" <?php if($roleAccessBtn?->can_add): ?> checked <?php endif; ?>>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="switcher mx-auto">
                                                        <input class="switcher_input" name="update" type="checkbox" <?php if($roleAccessBtn?->can_update): ?> checked <?php endif; ?>>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="switcher mx-auto">
                                                        <input class="switcher_input" name="delete" type="checkbox" <?php if($roleAccessBtn?->can_delete): ?> checked <?php endif; ?>>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </td>
                                                ...
                                                <td>
                                                    <label class="switcher mx-auto">
                                                        <input class="switcher_input" name="export" type="checkbox" <?php if($roleAccessBtn?->can_export): ?> checked <?php endif; ?>>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="switcher mx-auto">
                                                        <input class="switcher_input" name="status" type="checkbox" <?php if($roleAccessBtn?->can_manage_status): ?> checked <?php endif; ?>>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="switcher mx-auto">
                                                        <input class="switcher_input" name="approve_or_deny" type="checkbox" <?php if($roleAccessBtn?->can_approve_or_deny): ?> checked <?php endif; ?>>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="switcher mx-auto">
                                                        <input class="switcher_input" name="assign_serviceman" type="checkbox" <?php if($roleAccessBtn?->can_assign_serviceman): ?> checked <?php endif; ?>>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="switcher mx-auto">
                                                        <input class="switcher_input" name="give_feedback" type="checkbox" <?php if($roleAccessBtn?->can_give_feedback): ?> checked <?php endif; ?>>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="switcher mx-auto">
                                                        <input class="switcher_input" name="take_backup" type="checkbox" <?php if($roleAccessBtn?->can_take_backup): ?> checked <?php endif; ?>>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('adminmodule::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/housecraft/public_html/Modules/AdminModule/Resources/views/admin/employee/role-edit.blade.php ENDPATH**/ ?>