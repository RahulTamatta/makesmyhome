<?php $__env->startSection('title',translate('Add_Serviceman')); ?>

<?php $__env->startSection('content'); ?>
    <div class="main-content">
        <div class="container-fluid">
            <div class="page-title-wrap mb-3">
                <h2 class="page-title"><?php echo e(translate('Add_New_Serviceman')); ?></h2>
            </div>
            
            <form action="<?php echo e(route('provider.serviceman.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div>
                                        <div class="upload-file">
                                            ...
                                            <div class="upload-file__img">
                                                <img src="<?php echo e(asset('public/assets/provider-module/img/media/upload-file.png')); ?>" alt="<?php echo e(translate('serviceman')); ?>">
                                            </div>
                        ...
                        <div class="row gx-xl-5">
                            <div class="col-md-6">
                                ...
                                <select class="select-identity theme-input-style mb-30" name="identity_type" required>
                                    <option disabled selected><?php echo e(translate('Select_Identity_Type')); ?></option>
                                    ...
                                    <option value="trade_license"><?php echo e(translate('Trade_License')); ?></option>
                                </select>
...
<?php echo $__env->make('providermanagement::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/housecraft/public_html/Modules/ServicemanModule/Resources/views/Provider/Serviceman/create.blade.php ENDPATH**/ ?>