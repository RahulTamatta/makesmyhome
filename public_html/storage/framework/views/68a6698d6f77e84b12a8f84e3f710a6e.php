<?php $__env->startSection('title',translate('service_setup')); ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title"><?php echo e(translate('add_new_service')); ?></h2>
                    </div>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="form-error-wrap">
                                                        <select class="js-select theme-input-style w-100 form-error-wrap" name="category_id" id="category-id">
                                                            <option value="0" selected
                                                                    disabled><?php echo e(translate('choose_Category')); ?> *
                                                            </option>
                                                ...
                                                <div class="mb-30">
                                                    <div class="form-floating form-floating__icon">
                                                        <input type="number" class="form-control" name="tax" min="0"
                                                               ...
                                                               required="" value="<?php echo e(old('tax')); ?>">
                                                ...
                                                <div class="mb-30">
                                                    <div class="form-floating form-floating__icon">
                                                        <input type="number" class="form-control"
                                                               ...
                                                               placeholder="<?php echo e(translate('Minimum bidding price')); ?> *"
                                                               required="" value="<?php echo e(old('min_bidding_price')); ?>">
                                                        <label><?php echo e(translate('Minimum bidding price')); ?> *</label>
                                                ...
                                                <div class="mb-30">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control w-100" name="tags"
                                                               placeholder="<?php echo e(translate('Enter_tags')); ?>"
                                                               data-role="tagsinput">
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="upload-file form-error-wrap">
                                                            ...
                                                            <div class="upload-file__img">
                                                                <img src="<?php echo e(asset('public/assets/admin-module/img/media/upload-file.png')); ?>"
                                                                        alt="<?php echo e(translate('service')); ?>">
                                                            </div>
                                                        ...
                                                        <div class="upload-file form-error-wrap">
                                                            ...
                                                            <div class="upload-file__img upload-file__img_banner">
                                                                <img src="<?php echo e(asset('public/assets/admin-module/img/media/banner-upload-file.png')); ?>"
                                                                     alt="<?php echo e(translate('service-cover-image')); ?>">
                                                            </div>
                                                            <span class="upload-file__edit">
                                                                <span class="material-icons">edit</span>
                                                            </span>
                                            ...
                                            <?php if($language): ?>
                                                ...
                                                <?php $__currentLoopData = $language?->live_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="d-none lang-form2" id="<?php echo e($lang['code']); ?>-form2">
                                                        ...
                                                        <div class="col-12 mt-4 mt-md-5">
                                                            <div class="form-error-wrap">
                                                                <label for="editor" class="mb-2"><?php echo e(translate('long_Description')); ?>(<?php echo e(strtoupper($lang['code'])); ?>)
                                            ...
                                            <?php else: ?>
                                                <div class="normal-form">
                                                    ...
                                                    <div class="col-12 mt-4 mt-md-5">
                                                        <div class="form-error-wrap">
                                                            <label for="editor" class="mb-2"><?php echo e(translate('long_Description')); ?>
                                        ...
                                        <div class="table-responsive p-01">
                                            <table class="table align-middle table-variation">
                                                <thead id="category-wise-zone" class="text-nowrap">
                                                    <?php echo $__env->make('servicemanagement::admin.partials._category-wise-zone',['zones'=>session()->has('category_wise_zones')?session('category_wise_zones'):[]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </thead>
                                                <tbody id="variation-table">
                                                    <?php echo $__env->make('servicemanagement::admin.partials._variant-data',['zones'=>session()->has('category_wise_zones')?session('category_wise_zones'):[]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </tbody>
                                            </table>
                                        </div>
                                    </section>
...
<?php echo $__env->make('adminmodule::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/housecraft/public_html/Modules/ServiceManagement/Resources/views/admin/create.blade.php ENDPATH**/ ?>