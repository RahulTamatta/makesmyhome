<?php $__env->startSection('title',translate('Wallet_Transaction_Report')); ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title"><?php echo e(translate('Wallet_Transaction_Report')); ?></h2>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                action="<?php echo e(route('admin.customer.wallet.report', ['transaction_type'=>$queryParams['transaction_type']])); ?>"
                                method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-30">
                                        <select class="js-select" name="trx_type">
                                            <option value="" selected disabled><?php echo e(translate('Select_type')); ?></option>
                                            <option
                                                value="all"<?php echo e(array_key_exists('trx_type', $queryParams) && $queryParams['trx_type']=='all'?'selected':''); ?>><?php echo e(translate('All')); ?></option>
                                            <?php $__currentLoopData = WALLET_TRX_TYPE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($type); ?>" <?php echo e(array_key_exists('trx_type', $queryParams) && $queryParams['trx_type']==$type?'selected':''); ?>><?php echo e(translate($type)); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 mb-30">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap gap-3 mb-4">
                                <div class="statistics-card statistics-card__total-orders border flex-grow-1">
                                    <h2><?php echo e(with_currency_symbol($totalDebit)); ?></h2>
                                    <h3><?php echo e(translate('Debit')); ?></h3>
                                    <div class="absolute-img" data-bs-toggle="tooltip"
                                         data-bs-title="<?php echo e(translate('Total debited from wallet')); ?>">
                                ...
                                <div class="statistics-card statistics-card__ongoing border flex-grow-1">
                                    <h2><?php echo e(with_currency_symbol(($totalCredit))); ?></h2>
                                    <h3><?php echo e(translate('Credit')); ?></h3>
                                    <div class="absolute-img" data-bs-toggle="tooltip"
                                         data-bs-title="<?php echo e(translate('Total credited to wallet')); ?>">
                                        <img src="<?php echo e(asset('public/assets/admin-module')); ?>/img/icons/info.svg"
                                             class="svg" alt="">
                                    </div>
                                </div>
                                ...
                                <div class="statistics-card statistics-card__subscribed-providers border flex-grow-1">
                                    <h2><?php echo e(with_currency_symbol($totalCredit - $totalDebit)); ?></h2>
                                    <h3><?php echo e(translate('Balance')); ?></h3>
                                    <div class="absolute-img" data-bs-toggle="tooltip"
                                         data-bs-title="<?php echo e(translate('Total credit')); ?> - <?php echo e(translate('Total debit')); ?>">
                                        <img src="<?php echo e(asset('public/assets/admin-module')); ?>/img/icons/info.svg"
                                             class="svg" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="all-tab-pane">
                                    <div class="data-table-top d-flex flex-wrap gap-10 justify-content-between">
                                        <form action="<?php echo e(url()->current() . '?' . request()->getQueryString()); ?>"
                                            ...
                                            <span class="search-form__icon">
                                                ...
                                                <input type="search" class="theme-input-style search-form__input"
                                                       ...
                                                       placeholder="<?php echo e(translate('search by user info')); ?>">
                                            </div>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center gap-3">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('wallet_export')): ?>
                                                <div class="dropdown">
                                                    <button type="button"
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                                        <li>
                                                            <a class="dropdown-item"
                                                               href="<?php echo e(route('admin.customer.wallet.report.download').'?'.http_build_query($queryParams)); ?>">
                                        ...
                                        <table class="table align-middle">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $filteredTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($transaction->reference_note): ?>
                                                            <span><?php echo e($transaction->reference_note); ?></span>
                                                        <?php else: ?>
                                                            <span>---</span>
                                                        <?php endif; ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <?php if(isset($transaction->to_user)): ?>
                                                            ...
                                                            <div
                                                                class="d-flex fz-10"><?php echo e(translate($transaction->to_user_account)); ?></div>
                                                        <?php else: ?>
                                                            <span
...
<?php echo $__env->make('adminmodule::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/housecraft/public_html/Modules/CustomerModule/Resources/views/admin/wallet/report.blade.php ENDPATH**/ ?>