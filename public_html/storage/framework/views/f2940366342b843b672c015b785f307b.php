...
<main class="main-area">
    ...
    <?php echo $__env->make('adminmodule::layouts.partials._status-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    success: function (response) {
                        if (response.length === 0) {
                            ...
                            $('.search-list-item').click(function () {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '<?php echo e(route('admin.search.routing.store')); ?>',
                                    data: {
                                        routeName: routeName,
                                        routeUri: routeUri,
...
<?php /**PATH /home/housecraft/public_html/Modules/AdminModule/Resources/views/layouts/master.blade.php ENDPATH**/ ?>