                    ...
                    <ul class="nav justify-content-end align-items-center gap-3 gap-md-4">
                        ...
                        <li>
                            <div class="messages pe--12">
                                <a href="<?php echo e(route('admin.chat.index', ['user_type' => 'customer'])); ?>" class="header-icon count-btn">
                            ...
                            <div class="user mt-n1">
                                <a href="#" class="header-icon user-icon" data-bs-toggle="dropdown">
                                    <img width="30" height="30"
                                         src="<?php echo e(auth()->user()->profile_image_full_path); ?>"

                                         class="rounded-circle aspect-square object-fit-cover" alt="<?php echo e(translate('profile_image')); ?>">
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('admin.profile_update')); ?>">
                                        <span class="text-truncate" title="<?php echo e(translate('Settings')); ?>"><?php echo e(translate('Settings')); ?></span>
                                    </a>
                                    <a class="dropdown-item admin-logout">
                                        <span class="text-truncate cursor-pointer" title="<?php echo e(translate('Sign Out')); ?>"><?php echo e(translate('Sign_Out')); ?></span>
                                    </a>
                                </div>
                            </div>
                        </li>
        ...
        <div class="modal-content modal-content__search border-0 <?php echo e(env('APP_ENV') == 'demo' ? 'mt-5' : ''); ?>">
            <div class="d-flex flex-column gap-3">
                <div class="d-flex gap-2 align-items-center rounded bg-card py-2 px-3">
                    ...
                    <button class="border-0 rounded-3 px-2 py-1" type="button" data-bs-dismiss="modal"><?php echo e(translate('Esc')); ?></button>
                </div>
...
<?php /**PATH /home/housecraft/public_html/Modules/AdminModule/Resources/views/layouts/partials/_header.blade.php ENDPATH**/ ?>