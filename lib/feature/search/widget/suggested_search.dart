// import 'package:makesmyhome/components/ripple_button.dart';
// import 'package:makesmyhome/components/core_export.dart';
...
//       children: [
//         Text('suggest_for_you'.tr,style: robotoMedium.copyWith(
...
//           child: Text(title.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: .5)),),
//         ),
