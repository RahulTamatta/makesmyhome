...
class _PaymentMethodListWidgetState extends State<PaymentMethodListWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    List<DigitalPaymentMethod> allPaymentMethods =
        Get.find<SplashController>().configModel.content?.paymentMethodList ??
            [];

    // Filter to show only Razorpay
    List<DigitalPaymentMethod> paymentMethodList = allPaymentMethods
        .where((method) =>
            method.gateway?.toLowerCase().contains('razor_pay') == true)
        .toList();
