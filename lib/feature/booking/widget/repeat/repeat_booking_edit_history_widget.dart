import 'package:makesmyhome/feature/booking/widget/repeat/repeat_history_expenssion_tile.dart';
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    Column(children: [
                                      //Text(element.serviceName ?? "", style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),),
                                      Text(
                                        historyLogs[index]
                                                .variantKey
                                                ?.replaceAll("-", " ")
