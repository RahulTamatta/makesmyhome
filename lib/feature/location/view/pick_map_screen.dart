                ...
                Expanded(
                  child: Stack(children: [
                    ...
                    GoogleMap(
                      initialCameraPosition: CameraPosition(
                          target: widget.fromAddAddress! 
                              ...
                              : _initialPosition ?? const LatLng(23.8103, 90.4125), // Default to Dhaka if null
                          zoom: 16
                      ),
                    ...
                    Positioned(
                      ...
                      child: InkWell(
                        onTap: () {
                          // Prevent crash if map controller is not yet available (e.g., web Maps JS not loaded)
                          if (_mapController == null) {
                            customSnackBar('Map is still loading, please wait a moment and try again', type: ToasterMessageType.info);
                            return;
                          }
