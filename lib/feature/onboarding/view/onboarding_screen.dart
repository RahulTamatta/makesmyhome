            ...
            Expanded(
              child: PageView.builder(
                ...
                itemBuilder: (context, index) => PagerContent(
                  ...
                  subText: onBoardingController.onBoardPagerData[onBoardingController.pageIndex]
                      ["subTitle"]!,
                  topImage: onBoardingController.onBoardPagerData[onBoardingController.pageIndex]
                      ["top_image"]!,
                  // index: index,
                ),
              ),
