        ...
        builder: (serviceController) {
          if (serviceController.service != null || widget.serviceID == null) {
            if (serviceController.service != null &&
              ...
              } else if (service.variations != null &&
                  service.variations!.isNotEmpty) {
                lowestPrice = (service.variations!.first.price ?? 0).toDouble();
                for (final v in service.variations!) {
                  final p = (v.price ?? 0).toDouble();
                  if (p < lowestPrice) lowestPrice = p;
                }
              } else if (service.crBasePrice != null &&
                  service.crBasePrice! > 0) {
                lowestPrice = (service.crBasePrice ?? 0).toDouble();
