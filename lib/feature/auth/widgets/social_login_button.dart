...
import 'package:makesmyhome/feature/auth/widgets/existing_account_bottom_sheet.dart';
...
class SocialLoginButton extends StatelessWidget {
  ...
  _onTap({required SocialLoginType socialLoginType, String? fromPage}) async {
    debugPrint('SocialLoginButton: Starting ${socialLoginType.name} login...');
    
    if (socialLoginType == SocialLoginType.google) {
      await Get.find<AuthController>().socialLogin();
      String? id = '', token = '', email = '', medium = '', userName = '';
      
      debugPrint('SocialLoginButton: Google account after sign-in: ${Get.find<AuthController>().googleAccount?.email}');
      ...
      if (Get.find<AuthController>().googleAccount != null) {
        ...
        debugPrint('SocialLoginButton: Calling loginWithSocialMedia with email: $email');
        ...
        debugPrint('SocialLoginButton: Google account is null, login failed or cancelled');
      }
