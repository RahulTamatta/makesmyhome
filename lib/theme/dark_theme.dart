...
ThemeData dark = ThemeData(
  ...
  primaryColor: const Color(0xFFDB4942), // Red from logo
  primaryColorLight: const Color(0xFFF0F4F8),
  primaryColorDark: const Color(0xFFC43C35), // Darker variant
  ...
  iconTheme: const IconThemeData(
    color: Color(0xFFDB4942), // Red icons
  ),
  ...
  outlinedButtonTheme: OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      foregroundColor: const Color(0xFFDB4942),
      side: const BorderSide(color: Color(0xFFFFBD59)), // Yellow outline
    ),
  ),

  colorScheme: const ColorScheme.dark(
    primary: Color(0xFFDB4942),        // Red
    secondary: Color(0xFFFFBD59),      // Yellow
    onSecondary: Color(0xFFFFE8B0),    // Light yellow
    onSecondaryContainer: Color(0xFF02AA05),
    tertiary: Color(0xFFFF6767),
    error: Color(0xFFBC4040),
