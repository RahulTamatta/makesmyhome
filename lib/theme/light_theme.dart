...
ThemeData light = ThemeData(
  useMaterial3: false,
  fontFamily: 'Roboto',
  primaryColor: const Color(0xFFDB4942), // Brand Red
  primaryColorLight: const Color(0xFFF0F4F8),
  primaryColorDark: const Color(0xff2b3941),
  secondaryHeaderColor: const Color(0xFF758493),
  ...
  textButtonTheme: TextButtonThemeData(
    style: TextButton.styleFrom(
      foregroundColor: const Color(0xFFDB4942), // Red text buttons
    ),
  ),
  ...
  outlinedButtonTheme: OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      side: const BorderSide(color: Color(0xFFFFBD59)), // Yellow border
    ),
  ),
