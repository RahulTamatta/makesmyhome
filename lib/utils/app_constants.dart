...
class AppConstants {
  static const String appName = 'Make My Home';
  static const String appVersion = '3.2';

  /// Flutter SDK : 3.29.3
  static String get baseUrl {
    // if (kDebugMode && kIsWeb && _isLocalDevelopment()) {
    //   return 'http://localhost:3001'; // CORS proxy for local web development only
    // }
    return 'https://housecraft.online';
  }

  // Check if running on localhost for development
  static bool _isLocalDevelopment() {
    try {
      // This will be true only when running on localhost during development
  ...
  // Google/Firebase web credentials (configure these for Flutter Web)
  // OAuth 2.0 Web Client ID from Google Cloud Console
  // Format: 1234567890-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.apps.googleusercontent.com
  static const String googleWebClientId =
      '1024512016620-v7ctqhf4tahphvbsprqhp0agarcflh6b.apps.googleusercontent.com';

  // Provide your Google Maps JavaScript API key (enable Maps JavaScript API)
  ...
  static const String subscriptionUri = '/api/subscriptionmodule/subscriptions';
  static const String mySubscriptionUri =
      '/api/subscriptionmodule/MySubcription';
  ...
  static const String geocodeUri =
      'https://housecraft.online/api/v1/customer/config/geocode-api';
  ...
  static const String changeLanguage =
      'https://housecraft.online/api/v1/customer/change-language';
